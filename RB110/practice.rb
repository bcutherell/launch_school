...
def solve(array)
  array.map { |word| match_count(word) }
end

p solve(["abode","ABc","xyzD"]) == [4,3,1] # true
p solve(["abide","ABc","xyz"]) == [4,3,0] # true
p solve(["IAMDEFANDJKL","thedefgh","xyzDEFghijabc"]) == [6,5,7] # true
p solve(["encode","abc","xyzD","ABmD"]) == [1, 3, 1, 3] # true
